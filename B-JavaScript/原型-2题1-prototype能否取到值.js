...
* */
console.log('F:', F)
console.log('F.prototype:', F.prototype) // 上面有打印:console.log('f.__proto__指向F.prototype:', f.__proto__ === F.prototype) // true
/*
c: ƒ ()
constructor: ƒ ()
[[Prototype]]: Object
...
console.log(f.a);
console.log(f.b); // undefined，但是能取到c,下面途径才能取到
// console.log(F.__proto__.b === f.__proto__.constructor.prototype.constructor.__proto__.b) // true
/*
